# PowerInfo for Windows


A basic software for Windows Laptops that tells you when your laptop gets unplugged or plugged in.

# PowerInfo (For Mac) Version (2.0.0) has been released!
...
For any bugs make a pull request
